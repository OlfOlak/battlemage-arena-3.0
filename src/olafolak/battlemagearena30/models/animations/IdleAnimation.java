...
/**
 * Extension of Animation class for distinguishing idle animation.
 * @author OlfOlak
 */
public class IdleAnimation extends DirectionalAnimation{
     ...
     */
    public IdleAnimation(int fps, double length, ArrayList<BufferedImage> leftFrames, ArrayList<BufferedImage> rightFrames) {
